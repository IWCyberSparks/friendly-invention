...
public class SceneController {
	...
	public void SwitchToSceneTwo(ActionEvent event) throws IOException {
		...
		try {
        ProcessBuilder processBuilder = new ProcessBuilder("python", "E:\\SceneSwitchingJFX\\Hackathon.py");
...
//				String PinCodestr = PinCode.text();
				...
				//Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sql2","root","Adityarawat123#");
				
				Connection con = DriverManager.getConnection("jdbc:mysql://"+URL+":"+PORT+"/"+NAME,NAME,PASS);

				Statement stmt = con.createStatement();
				String sql = "Insert into BankAuction values('"+AuctionBankstr+"','"+Phonestr+"','"+ReservePricestr+"','"+EMDstr+"','"+AuctionPublicationDatestr+"','"+AuctionSubmitionDeadlinestr+"','"+AuctionDatestr+"','"+PropertyTypestr+"','"+AuctionStatusstr+"','"+BorrowersNamestr+"','"+Areastr+"','"+Citystr+"','"+Statestr+"')";
